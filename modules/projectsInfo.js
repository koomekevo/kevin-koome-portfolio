...
const projects = [
  {
    ...
    descriptionMobilePopup:
      'This app allows us to be aware of our daily tasks. We can just drag a task to set it in the order we wanted and not only that but we can checked if we already finished the task, Then we can delete the task.',
    descriptionDesktopPopUp:
